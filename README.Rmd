...
The function `findIBD()` conveniently wraps the key steps of the package: it fits a HMM, identifies IBD segments, and computes marker-wise posterior IBD probabilities. 
```{r}
